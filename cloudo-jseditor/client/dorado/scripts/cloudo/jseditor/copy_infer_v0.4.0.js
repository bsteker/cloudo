...
(function(mod) {
    ...
    //copy//
    var CLOUDO_PROTOCOL = {
        setTernParameter: function(obj, tparam) {
            if (tparam) cloudo.HINT.ExpressionHelper.setTernParameter(obj, tparam);
        },
        setTernParameter_AVal_propagate: function(aval, target){
            var tparam = cloudo.HINT.ExpressionHelper.getTernParameter(aval);
            if (tparam) {
                if (target.retval && target.self) {//IsCallee
                	cloudo.HINT.ExpressionHelper.setTernParameter(target.retval, tparam);
                }else {
                	cloudo.HINT.ExpressionHelper.setTernParameter(target, tparam);
                }
            }
        },
        setTernParameter_HashMethodCall_addType: function(hmc, callee){
            var tparam = cloudo.HINT.ExpressionHelper.getTernParameter(hmc);
            if (tparam) cloudo.HINT.ExpressionHelper.setTernParameter(callee.self, tparam);
        }
    };
    ...
    var AVal = exports.AVal = function(tparam) {
        this.types = [];
        this.forward = null;
        this.maxWeight = 0;
        CLOUDO_PROTOCOL.setTernParameter(this, tparam);
    };
    AVal.prototype = extend(ANull, {
        ...
        propagate: function(target, weight) {
            ...
            CLOUDO_PROTOCOL.setTernParameter_AVal_propagate(this, target);
    ...
    var HasMethodCall = constraint("propName, args, argNodes, retval", {
        ...
        addType: function(obj, weight) {
            ...
            CLOUDO_PROTOCOL.setTernParameter_HashMethodCall_addType(this, callee);
        },
    ...
    var typeFinder = {
        ...
        CallExpression: function(node, scope) {
            ...
            if (f.computeRet) {
                ...
                //copy//
                return f.computeRet(self, args, node.arguments, node);
            } else {
                return f.retval;
            }
        },
